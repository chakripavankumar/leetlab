...
import {
  PLATFORM_FEATURES,
  PLATFORM_STATS,
} from "../../constants/platformFeature";
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-base-content/70 max-w-3xl mx-auto">
                Join thousands of developers sharpening their skills with our
                comprehensive coding platform. Track progress, solve challenges,
                and level up your programming abilities with the help of our
                built-in{" "}
                <span className="text-primary font-semibold">AI mentor</span>
                —DSA CodeLab AI Bot. Get hints, explanations, and pseudocode
                without spoilers.
              </p>

              <p className="text-md md:text-lg text-success text-center font-medium mt-4">
                🚀 Trusted by over 10,000 developers—and now smarter with AI to
                help you learn better, not just faster.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-base-content/70 max-w-2xl mx-auto">
              Everything you need to become a better programmer, all in one
              place
            </p>
          </div>
