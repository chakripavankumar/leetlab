...
const Contents = ({
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Tabs */}
      <div className="tabs tabs-border bg-base-200 flex-shrink-0">
        <span
        ...
        <div className="h-full overflow-y-auto px-6 py-2">
          {activeTab === "description" && (
            <div className="prose prose-sm max-w-none">
              ...
              <div className="badge badge-warning capitalize my-3">
                {difficulty}
              </div>
              ...
              <div className="space-y-2 text-base-content">
                ...
                {Array.isArray(examples) &&
                  examples.map((exmp, index) => (
                    <div
                      key={index}
                      className="card bg-base-200 p-4 rounded-lg mt-6"
                    >
              ...
              <>
                <div className="space-y-2">
                  ...
                  <p className="text-sm opacity-70">
                    ...
                    {formatDate(submissionData?.submittedOn, true)}
                  </p>
                  {!submissionData?.isAllPassed && (
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="border border-base-300 rounded-lg p-3">
                      ...
                      <p className="text-center p-2 text-2xl text-white">
                        {(parseInt(submissionData?.memory) / 1024).toFixed(2)}{" "}
                        KB
                      </p>
                    </div>
                  </div>
