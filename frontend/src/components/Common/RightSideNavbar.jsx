      ...
      <div className="dropdown dropdown-end">
        ...
        >
          <div className="w-10 rounded-full ring-2 ring-slate-600/30 hover:ring-emerald-500/50 transition-all duration-200">
            <img
              src={
                authUser?.image || "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"
              }
              alt="User Avatar"
        ...
        <ul
          tabIndex={0}
          className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-2xl bg-slate-800 border border-slate-600/30 rounded-2xl w-64 bacldrop-blur-4xl"
        >
          {/* User Info */}
