...
export const PLATFORM_FEATURES = [
  {
    ...
    title: "AI Assistance",
    description:
      "Get hints, pseudocode, and step-by-step guidance from DSA CodeLab AI Bot",
  },
  {
  ...
  },
  {
    ...
    description:
      "Enjoy a smooth and modern coding experience with our custom-built code editor.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Explore our extensive problem library before creating an account.",
  },
  {
    icon: <Target className="w-8 h-8 text-success" />,
    title: "15+ Language Support",
    description:
      "Code in Python, JavaScript, and Java with full syntax highlighting.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Expertly crafted problem sets designed to enhance your coding skills.",
  },
];
