...
function App() {
  ...
  return (
    <>
      ...
      <Routes>
        <Route
          path={routes.problems.problem}
          element={<ProblemContentInterface />}
        />
        <Route
          path={routes.login}
          element={
            isAuthenticated ? <Navigate to={routes.problems.all} /> : <Login />
          }
        />
        <Route
          ...
          element={
            isAuthenticated ? (
              <Navigate to={routes.problems.all} />
            ) : (
              <Register />
            )
          }
        ...
        <Route path={routes.root} element={<Layout />}>
          ...
          <Route element={<ProtectedRoute allowedRoles={["USER", "ADMIN"]} />}>
            ...
            <Route
              path={routes.submissions.submission}
              element={<Submission />}
            />
          ...
          <Route element={<ProtectedRoute allowedRoles={["ADMIN"]} />}>
            ...
            <Route
              path={routes.admin.createProblem}
              element={<CreateProblem />}
            />
            <Route
              path={routes.admin.updateProblem}
